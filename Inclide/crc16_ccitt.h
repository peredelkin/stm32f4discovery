 ...
 * @return CRC16.
 */
extern uint16_t crc16_ccitt(const uint8_t* data, size_t size);
 ...
 * @return CRC16.
 */
extern uint16_t crc16_ccitt_initial(const uint8_t* data, size_t size, uint16_t init);
 ...
 * @return CRC16.
 */
extern uint16_t crc16_ccitt_next(uint16_t crc, const uint8_t* data);
